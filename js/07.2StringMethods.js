...
// let text="hello world"
// let text2=text.slice(2,7) //llo w
...
// console.log(char); //ELLO WOR

// let text = "HELLO WORLD";
// let char = text.substring(1,8); //ELLO WO
...
// let text="hello";
// let char = "world"
// console.log(text.concat(" ",char)) //hello world

// 10.trim() //remoes white spavces
// let text = "   HELLO WORLD          ";
...
// console.log(char); //HELLO WORLD   8
...
// 14.The padEnd() method pads a string from the end - pading nothing but addition of extra material pattern or anything
// let text="hello"
...
// console.log(game); //hello hello hello hello hello
...
// console.log(text2); //[ 'Hello World Hello' ]
...
// console.log(text2); //[ 'ello', index: 1, input: 'Hello World Hello', groups: undefined ]

// let text = "I love cats. Cats are very easy to love. Cats are very popular."
// let text2=text.match(/cats/i);
// console.log(text2);['cats',index: 7, input: 'I love cats. Cats are very easy to love. Cats are very popular.',
//     groups: undefined
//   ]
